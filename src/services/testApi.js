...
const testApi = [
  {
    ...
    population: '200000',
    films: [
      `https://swapi-trybe.herokuapp.com/api/films/${um}/`,
      `https://swapi-trybe.herokuapp.com/api/films/${tres}/`,
      `https://swapi-trybe.herokuapp.com/api/films/${quatro}/`,
      `https://swapi-trybe.herokuapp.com/api/films/${cinco}/`,
      `https://swapi-trybe.herokuapp.com/api/films/${sex}/`,
    ],
  ...
  },
  {
    ...
    population: 'unknown',
    films: [
      `https://swapi-trybe.herokuapp.com/api/films/${dois}/`,
    ],
